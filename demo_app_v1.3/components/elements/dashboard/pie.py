...
class Pie(Dashboard.Item):
    ...
    def __call__(self, title, json_data):
        try:
            ...
            with mui.Box(sx={"flex": 1, "minHeight": 0}):
                nivo.Pie(
                    ...
                    fill=[
                        ...
                        { "match": { "label": "病房区域I" }, "id": "dots" },
                        { "match": { "label": "病房区域II" }, "id": "lines" },
                        { "match": { "label": "办公区域" }, "id": "dots" },
                        { "match": { "label": "公共走廊" }, "id": "lines" },
                        { "match": { "label": "娱乐活动区" }, "id": "lines" }
                    ],
                    legends=[
                        {
                            "anchor": "bottom",
